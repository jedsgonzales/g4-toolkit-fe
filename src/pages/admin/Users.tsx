...
export default function Users() {
    ...
    return (
        <Page title={'Backoffice - Users'} sx={{ minHeight: '79vh' }} >
            {/* Modals */}
            <UsersCreateForm user={selectedItem} open={openForm} handleClose={() => setOpenForm(false)} />
                            ...
                            <TableContainer component={Paper} sx={{ width: "100%", display: "table", tableLayout: "fixed" }}>
                                <Table>
                                    ...
                                    <TableBody>
                                        ...
                                        {users.items.map((obj: any, idx: number) => {
