...
// components
// layout components
import menus from "src/assets/menusUser.json";
...
export default function Layout() {
  ...
  useEffect(() => {
    ...
    (async () => {
      try {
        if (
          !auth.data?.roles?.find(
            (r) => r.RoleName === "Staff" || r.RoleName === "Admin"
          )
        ) {
          // refresh
          console.log("not an user or admin");
          // load user infos
